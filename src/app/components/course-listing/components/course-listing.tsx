            ...
            <div className="flex items-center space-x-4">
              ...
              {user ? (
                ...
                <Link href="/login">
                  <Button 
                    variant="outline"
                    className="text-white border-white hover:bg-purple-900"
                  >
                    Login
                  </Button>
                </Link>
                ...
                <div className="grid gap-4 py-4">
                  ...
                  <div className="grid grid-cols-4 items-center gap-4">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setNewCourse({ ...newCourse, accessType: value as 'free' | 'paid' })}
                    >
                ...
                <CardFooter className="flex justify-between items-center">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-sm text-gray-400 ml-2">
                      /{course.videoCount || course.chapters?.reduce((acc, chapter) => acc + chapter.lessons.length, 0) || 0} Videos
                    </span>
                  </div>
                </CardFooter>
                <CardFooter className="flex justify-between items-center">
